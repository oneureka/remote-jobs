...
Epic Games 是一家领先的互动娱乐公司和 3D 引擎技术提供商。Epic 运营着全球最大的游戏之一《堡垒之夜》，并开发了虚幻引擎——该引擎为全球众多领先游戏提供动力，并被应用于影视、建筑、汽车和仿真等行业。通过《堡垒之夜》、虚幻引擎、Epic 游戏商城和 Epic 在线服务，Epic 为开发者和创作者提供了一个端到端的数字生态系统。

官方网站：https://epicgames.com
