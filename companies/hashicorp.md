...
HashiCorp 是 IBM 旗下公司，通过基础设施云帮助企业实现多云和混合环境的自动化与安全化。其基础设施生命周期管理和安全生命周期管理解决方案套件（Terraform、Vault、Consul、Nomad）基于年下载量超过 5 亿次的开源项目构建。

官方网站：https://hashicorp.com
