...
PingCAP 是 TiDB 背后的公司，TiDB 是一款与 MySQL 兼容的先进开源分布式 SQL 数据库。PingCAP 由三位资深基础设施工程师于 2015 年创立，自成立之初就践行远程友好工作文化，团队成员分布在北京、上海、广州、深圳、成都、杭州、硅谷等多地。TiDB 是全球最受欢迎的开源数据库项目之一，TiKV 是 CNCF 毕业项目。
