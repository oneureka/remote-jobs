...
Deno 是一个快速、开源、完全兼容 Node.js 的 JavaScript 运行时，内置 TypeScript 及所需的一切工具。基于 Rust 构建，提供精细的安全控制，默认拒绝文件系统、网络和环境访问。Deno 为数百万项目提供动力，并被 Slack、Netlify、GitHub、Supabase 和 Stripe 等团队用于生产环境。
